...
interface CounterSelectModalProps {
  ...
  counters: TemplateListItem[];
  isLoading: boolean;
  onSelect: (counter: TemplateListItem) => void;
  isCreating?: boolean;
}

export function CounterSelectModal({
  open,
  onOpenChange,
  counters,
  isLoading,
      ...
      <DialogContent className="sm:max-w-[600px] p-0 overflow-hidden border border-[#E5E7EB] shadow-xl bg-white rounded-none">
        <DialogHeader className="px-6 py-5 border-b border-[#E5E7EB]">
          <DialogTitle className="text-[18px] font-semibold text-[#111827]">
            Select Counter Offer Template
          </DialogTitle>
          <DialogDescription className="text-[13px] text-[#6B7280]">
            Choose a counter offer template to add to this purchase contract.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="px-6 py-4 border-b border-[#E5E7EB]">
          <div className="relative">
            ...
            <Input
              placeholder="Search counter offers..."
              value={searchQuery}
            ...
            <div className="text-center py-12">
              ...
              <p className="text-[14px] font-semibold text-[#111827] mb-1">
                {searchQuery
                  ...
                  : "No counter offer templates available"}
              </p>
              <p className="text-[12px] text-[#6B7280]">
                {searchQuery
                  ? "Try a different search term"
                  : "Counter offer templates need to be configured for this jurisdiction"}
              </p>
            </div>
          ) : (
